// This is final version of test_templates.cpp
// Include important test cases for templates:
// 1. test templates with ADT of class, including Date.hpp
// 2. test templates with ADT of struct Point, to test operator==, operator+, assignment operator

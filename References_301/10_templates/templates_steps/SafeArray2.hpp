// This is template class version of SafeArray2.hpp
// no change from SafeArray1.hpp, just match version numbering
...
#include "SafeArray2.tpp" // include the template implementation file

// This is Date2c.cpp file, change from Date.cpp of the starter code is:
// 1. Implement the default constructor
// 2. Make sure we have == operator for Date class
// 3. Make sure if needed, implement custom copy constructor and assignment operator
...
Date::Date() : month(JAN), day(1), year(min_year)
{
}

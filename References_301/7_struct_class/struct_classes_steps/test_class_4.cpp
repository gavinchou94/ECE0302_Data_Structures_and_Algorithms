// This is test_class_4.cpp
// Changes from test_class_3.cpp
// 1. change all instances of Date to class style
// 2. accessing via .field is changed to accessing via getter functions

// This is the test_interface1c.cpp, changes from test_interface1b.cpp:
// 1. add test cases to show uncopyable class and derived class from uncopyable class
...
TEST_CASE("Test uncopyable class and derived class from uncopyable class", "[interface]")
{
    // uncomment below to check errors
    // object of uncopyable class cannot be copied
    ...
    // uncomment below to check errors
    // object of uncopyable class' derived object cannot be copied
